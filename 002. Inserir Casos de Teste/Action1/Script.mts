...
datatable.ImportSheet localFicheiro & "CT.xlsx", "Test Cases", "Global"
...
while DataTable.Value("Titulo","Global") <>""
	...
	Browser("PTPRMOB1171646I board").Page("Levantamento ATM sem Cartão").WebEdit("cboIssueType").Set "Test"
